...
ClapTrap::ClapTrap(void) {
    ...
    std::cout << this->_name << " ClapTrap constructor up" << std::endl;
    return; 
}
...
ClapTrap::ClapTrap(std::string name): _name(name) {
    ...
    this->_energy_points = 10;
    this->_attack_damage = 0;
    std::cout << this->_name << " ClapTrap with string constructor up" << std::endl;
    return;    
}

ClapTrap::ClapTrap(ClapTrap const & src) {
   
    std::cout << " ClapTrap copy constructor up" << std::endl;
    *this = src;
    return;
}
...
ClapTrap::~ClapTrap(void) {
    ...
    std::cout << this->_name << " ClapTrap destructor up" << std::endl;
    return;
}
